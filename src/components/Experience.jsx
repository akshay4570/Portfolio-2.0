    ...
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div>
        {EXPERIENCES.map((experience, index) => {
          const description = parse(experience.description);
            ...
            <div key={index} className="mb-10 flex flex-wrap lg:justify-center">
              ...
              >
                ...
                {experience.technologies.map((technology, index) => (
                  <span
                    key={index}
                    className="mr-2 mt-4 rounded bg-neutral-900 px-2 py-1 text-sm font-medium text-purple-800 hover:transform hover:scale-110"
                  >
                    {technology}
                  </span>
                ))}
